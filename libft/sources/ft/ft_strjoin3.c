...
/*   Updated: 2023/03/26 20:47:12 by lucas            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * It takes three strings, concatenates them, and returns the result
 * 
 * @param s1 The first string to be joined.
 * @param s2 the string to be appended to s1
 * @param s3 the string to be appended to the end of s1 and s2
 * 
